...
Here is a short list of what Gapotchenko.FX can do:
  ...
  - **Use the latest .NET features, even with older target frameworks.**
    Gapotchenko.FX achieves this providing the automatic set of polyfills
  ...
  - **Better utilize the hardware and software capabilities of a host environment.**
    Many Gapotchenko.FX primitives are backed up by algorithms that use acceleration provided by the underlying OS and hardware.
