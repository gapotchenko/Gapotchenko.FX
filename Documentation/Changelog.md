...
- Added ability to supply an additional cancellation token to the synchronous execution of an asynchronous task in `Gapotchenko.FX.Threading.Tasks.TaskBridge`
