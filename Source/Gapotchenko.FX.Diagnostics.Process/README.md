...
For instance, Windows OS represents a command line of a process as a single string, while Unix operating systems represent the command line as a strongly-typed array of command-line arguments.
