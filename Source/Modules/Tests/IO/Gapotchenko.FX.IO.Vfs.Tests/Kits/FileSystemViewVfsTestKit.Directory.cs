...
partial class FileSystemViewVfsTestKit
{
    ...
    public void FileSystemView_Vfs_File_CreateWithExistingFileNameClash()
    {
        ...
        static void Mutate(IFileSystemView vfs, string rootPath)
        {
            ...
            Assert.ThrowsExactly<IOException>(() => vfs.CreateDirectory(entryPath));
        }
    ...
    public void FileSystemView_Vfs_Directory_Move()
    {
        ...
        void Mutate(IFileSystemView vfs, string rootPath)
        {
            ...
            Assert.ThrowsExactly<IOException>(() => vfs.MoveDirectory(Root("C"), Root("D")));
            ...
            Assert.ThrowsExactly<IOException>(() => vfs.MoveDirectory(Root("E"), Root("F")));
    ...
    public void FileSystemView_Vfs_Directory_MoveTo(bool reverse)
    {
        ...
        void Mutate(IFileSystemView sourceVfs, string sourceRootPath, (IVirtualFileSystem, string) state)
        {
            ...
            Assert.ThrowsExactly<IOException>(() => sVfs.MoveDirectory(SR("C"), new VfsLocation(dVfs, DR("D"))));
            ...
            Assert.ThrowsExactly<IOException>(() => sVfs.MoveDirectory(SR("E"), new VfsLocation(dVfs, DR("F"))));
