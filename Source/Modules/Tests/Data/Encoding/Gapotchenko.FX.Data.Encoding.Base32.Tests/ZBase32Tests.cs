...
public class ZBase32Tests
{
    ...
    [TestMethod]
    public void ZBase32_Empty() => TestVector([], "");

    [TestMethod]
    public void ZBase32_Bytes_TV1() => TestVector([240, 191, 199], "6n9hq");

    [TestMethod]
    public void ZBase32_Bytes_TV2() => TestVector([212, 122, 4], "4t7ye");

    [TestMethod]
    public void ZBase32_Bytes_TV3() => TestVector([0xff], "9h");

    [TestMethod]
    public void ZBase32_Bytes_TV4() => TestVector([0xb5], "sw");

    [TestMethod]
    public void ZBase32_Bytes_TV5() => TestVector([0x34, 0x5a], "gtpy");

    [TestMethod]
    public void ZBase32_Bytes_TV6() => TestVector([0xff, 0xff, 0xff, 0xff, 0xff], "99999999");

    [TestMethod]
    public void ZBase32_Bytes_TV7() => TestVector([0xff, 0xff, 0xff, 0xff, 0xff, 0xff], "999999999h");
    ...
    [TestMethod]
    public void ZBase32_Bytes_TV9() => TestVector([0x10, 0x11, 0x10], "nyety");

    [TestMethod]
    public void ZBase32_Bits_TV1() => TestVector([0], "y", 1);

    [TestMethod]
    public void ZBase32_Bits_TV2() => TestVector([128], "o", 1);

    [TestMethod]
    public void ZBase32_Bits_TV3() => TestVector([64], "e", 2);

    [TestMethod]
    public void ZBase32_Bits_TV4() => TestVector([192], "a", 2);

    [TestMethod]
    public void ZBase32_Bits_TV5() => TestVector([0, 0], "yy", 10);

    [TestMethod]
    public void ZBase32_Bits_TV6() => TestVector([128, 128], "on", 10);

    [TestMethod]
    public void ZBase32_Bits_TV7() => TestVector([139, 136, 128], "tqre", 20);

    [TestMethod]
    public void ZBase32_Bits_TV8() => TestVector([245, 87, 189, 12], "6im54d", 30);

    [TestMethod]
    public void ZBase32_Bits_TV9() => TestVector([0xff, 0xe0], "99o", 11);

    [TestMethod]
    public void ZBase32_Bits_TV10() => TestVector([0x10, 0x11, 0x10], "nyet", 20);

    [TestMethod]
    public void ZBase32_Bits_TV11() => TestVector([0, 0, 0], "yyyy", 18);

    [TestMethod]
    public void ZBase32_Bits_TV12() => TestVector([0, 0, 0, 0], "yyyyy", 25);
