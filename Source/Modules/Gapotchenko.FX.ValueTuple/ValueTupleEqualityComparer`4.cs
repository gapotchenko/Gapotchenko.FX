...
sealed class ValueTupleEqualityComparer<T1, T2, T3, T4> : IEqualityComparer<ValueTuple<T1, T2, T3, T4>>
{
        ...
        IEqualityComparer<T4>? comparer4)
    {
        ...
        m_Comparer4 = comparer4 ?? EqualityComparer<T4>.Default;
    }
    ...
    readonly IEqualityComparer<T4> m_Comparer4;
