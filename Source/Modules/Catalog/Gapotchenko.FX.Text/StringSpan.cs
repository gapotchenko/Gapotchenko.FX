...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StringSpan"/> structure.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether the current <see cref="StringSpan"/> structure is equal to another <see cref="StringSpan"/>.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether the current <see cref="StringSpan"/> structure is equal to another object.
    /// </summary>
    ...
    /// <summary>
    /// Gets a hash code for the current <see cref="StringSpan"/> structure.
    /// </summary>
    /// <returns>A hash code for the current <see cref="StringSpan"/> structure.</returns>
    public override int GetHashCode() => HashCode.Combine(StartIndex, Length);

    /// <summary>
    /// Indicates whether two <see cref="StringSpan"/> structures are equal.
    /// </summary>
    /// <param name="a">The first value to compare.</param>
    /// <param name="b">The second value to compare.</param>
    /// <returns><see langword="true"/> if the specified <see cref="StringSpan"/> structures are equal; otherwise, <see langword="false"/>.</returns>
    public static bool operator ==(StringSpan a, StringSpan b) => a.Equals(b);

    /// <summary>
    /// Indicates whether two <see cref="StringSpan"/> structures are not equal.
    /// </summary>
    /// <param name="a">The first value to compare.</param>
    /// <param name="b">The second value to compare.</param>
    /// <returns><see langword="true"/> if the specified <see cref="StringSpan"/> structures are not equal; otherwise, <see langword="false"/>.</returns>
    public static bool operator !=(StringSpan a, StringSpan b) => !a.Equals(b);
