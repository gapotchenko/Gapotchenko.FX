    ...
    where TKey : notnull
{
    ...
    bool TryInsert(int index, TKey key, TValue value, InsertionBehavior behavior)
    {
...
#pragma warning restore CS8767 // Nullability of reference types in type of parameter of doesn't match implicitly implemented member (possibly because of nullability attributes)
    ...
    [MemberNotNull(nameof(_buckets))]
    [MemberNotNull(nameof(_entries))]
    void Resize(int newSize, bool forceNewHashCodes = false)
    {
    ...
    public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>, IDictionaryEnumerator
    {
        ...
        readonly bool _useDictionaryEntry;
    ...
    public sealed class KeyCollection : IList<TKey>, IReadOnlyList<TKey>, IList
    {
        ...
        public struct Enumerator : IEnumerator<TKey>
        {
            ...
            OrderedDictionary<TKey, TValue>.Enumerator _enumerator;
