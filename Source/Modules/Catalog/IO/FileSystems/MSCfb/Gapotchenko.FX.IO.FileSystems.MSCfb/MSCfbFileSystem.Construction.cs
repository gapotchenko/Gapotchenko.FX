...
partial class MSCfbFileSystem
{
    ...
    /// </param>
    public MSCfbFileSystem(Stream stream, bool leaveOpen) :
    ...
    public MSCfbFileSystem(Stream stream, bool leaveOpen, MSCfbFileSystemOptions? options) :
        this(stream, leaveOpen, options, null)
    {
    }

    internal MSCfbFileSystem(Stream stream, bool leaveOpen, MSCfbFileSystemOptions? options, VfsStorageContext? context,
