...
The benefit of using `AsyncCriticalSection` in comparison to `AsyncLock` is that the former uses less computational resources because it does not track recursion.
