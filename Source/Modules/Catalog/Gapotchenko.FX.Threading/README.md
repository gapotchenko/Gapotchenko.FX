...
The benefit of using `AsyncCriticalSection` in comparison to `AsyncLock` is that the former uses fewer computational resources because it does not track lock recursion.
