...
public abstract class TestBase<T> : TestBase
{
    ...
    public static IEnumerable<object[]> EnumerableTestData()
    {
        ...
        {
            foreach (EnumerableType? enumerableTypeNullable in Enum.GetValues(typeof(EnumerableType)))
            {
                var enumerableType = enumerableTypeNullable ?? throw new InvalidOperationException();
