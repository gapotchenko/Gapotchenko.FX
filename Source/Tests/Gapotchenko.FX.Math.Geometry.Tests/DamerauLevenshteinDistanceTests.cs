...
{
    [TestMethod]
    public void DamerauLevenshteinDistance_Basics()
    {
    ...
    [TestMethod]
    public void DamerauLevenshteinDistance_MaxDistance()
    {
    ...
    {
        return StringMetrics.DamerauLevenshteinDistance(a, b, maxDistance);
    }
}
